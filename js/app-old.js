...
function loadWeather() {
    ...
    console.log(zip);    
    //var code = document.getElementById('countryCode').value.toUpperCase();
    //var loc = zip+","+code;    

    var conditionsPath = "http://api.openweathermap.org/data/2.5/weather?q="+zip+"&units=metric&APPID=0dfa7081b88c8bb4ce043507ed280eb2&cnt=3";
    var forecastPath = "http://api.openweathermap.org/data/2.5/forecast?q="+zip+"&units=metric&APPID=0dfa7081b88c8bb4ce043507ed280eb2&cnt=3";
